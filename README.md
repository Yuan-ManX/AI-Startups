...
| [Bland AI](https://www.bland.ai)              | Bland AI - Automate Phone Calls with Conversational AI. Transform your enterprise communication with Bland AI. Automate inbound and outbound phone calls using AI that sounds human. Bland is a platform for AI phone calling. Using our API, you can easily send or receive phone calls with a programmable voice agent.            |  Bland AI  |   Voice    |
| [Cartesia](https://cartesia.ai/)              | Cartesia - Real-time multimodal intelligence for every device. Our mission is to build the next generation of AI: ubiquitous, interactive intelligence that runs wherever you are. We're pioneering the model architectures that will make it possible.            |  Sonic  |   LLM、Multimodal、Voice   |
| [Cartwheel](https://getcartwheel.com/home)              | Cartwheel is a powerful text-to-animation platform. Animate characters for your video, game, app, ad, social, AR or VR project simply by typing.            |  Cartwheel  |   Animate、3D、Video、Game   |
| [Character.AI](https://character.ai/)              | Character.AI - Personalized AI for every moment of your day. Our mission is to empower everyone globally with personalized AI. We were founded by AI pioneers Noam Shazeer and Daniel De Freitas, and we make one of the world’s leading personal AI platforms, Character.AI. Character.AI is a full-stack AI company with a globally scaled direct-to-consumer platform. We are uniquely centered around people, letting users personalize their experience by interacting with AI “Characters.”            |  Character.AI  |   LLM、Avatar   |
| [Cognition AI](https://www.cognition.ai/)              | Cognition AI - An applied AI lab building end-to-end software agents. We’re building collaborative AI teammates that enable engineering teams to strive for more ambitious goals. We’re the makers of Devin, the first AI software engineer.            |  Devin  |   Code   |
...
| [Cosine AI](https://cosine.sh/)              | Cosine AI - Human Reasoning Lab. Cosine is a Human reasoning lab that trains AI to reason like a human. Creating AI colleagues that are truly autonomous.            |  Genie  |   Code   |
| [Cursor](https://www.cursor.com/)              | Cursor - The AI Code Editor. Built to make you extraordinarily productive, Cursor is the best way to code with AI.            |  Cursor  |   Code   |
...
| [DeepSeek](https://www.deepseek.com/)              | DeepSeek, unravel the mystery of AGI with curiosity. Answer the essential question with long-termism.            |  DeepSeek R1、DeepSeek V3、DeepSeek VL、DeepSeek Coder、DeepSeek Math、DeepSeek LLM  |   LLM、Code   |
...
| [Inception Labs](https://www.inceptionlabs.ai/)              | Inception’s diffusion-based approach to language generation is inspired by advanced AI systems for images and video like Midjourney and Sora and provides unprecedented speed, quality, and generative control.            |  Mercury  |   LLM    |
...
| [Promise](https://www.promisestudios.com/)              | Promise — a new studio built from the ground up to push the boundaries of storytelling with the transformative power of Generative AI. Promise will produce original films, series, and new formats in collaboration with the world's best Gen AI artists and storytellers. Our goal is to foster an environment where creativity and innovation can thrive, bringing bold ideas to life and captivating audiences around the world.            |  Promise  |   Gen AI Artists、Film、Video   |
